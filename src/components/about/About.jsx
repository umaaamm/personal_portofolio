  ...
  return (
    ...
    <div className={`${styles.about__container} container grid`}>
      ...
      <div className={styles.about__data}>
        ...
        <a href="https://raw.githubusercontent.com/umaaamm/umam/9234ea3415c5c3461c715d99a570fca2669e8a03/cv_kurniawan_gigih_lutfi_umam.pdf" download="CV_Kurniawan Gigih Lutfi Umam" className="button button__flex">
          {button_cv}
          <svg
